...
const Navbar = ({ onSearchClick }) => {
  return (
    <nav className="max-w-300 w-full flex items-center justify-between px-5 py-4 border border-white/10 rounded-[18px] bg-slate-900/45 backdrop-blur-[8px] shadow-[0_10px_25px_rgba(0,0,0,0.2)] text-white">
      <div className="logo">
